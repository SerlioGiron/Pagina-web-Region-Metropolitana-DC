export const units = [
    {
        ...
        descripcion:
            "La Jefatura Regional es la instancia gerencial de mayor autoridad en la Región Sanitaria, y por tanto es el responsable directo de su conducción y del cumplimiento de todas las funciones que en ella se desarrollan. \n\nConduce e impulsar la implementación de las políticas, estrategias, planes y proyectos institucionales de salud en el ámbito geográfico de su competencia, gestiona el óptimo aprovechamiento de los recursos y el acceso de la población a los servicios de salud.",
        subsecciones: [],
    },
    {
    ...
    {
        name: "Unidad de Servicios Legales",
        descripcion:
            "La Unidad de Servicios Legales es una instancia de asesoría responsable de asesorar a la Jefatura Regional y demás instancias organizativas, en materia legal, procurando el cumplimiento de la legislación y normativa jurídica en cada una de las acciones de la Región Sanitaria. \n\nRealiza funciones de asesoría, consultoría, representación y procuración en el ámbito geográfico de la Región Sanitaria.",
        subsecciones: [],
    },
    {
    ...
    },
    {
        ...
        descripcion:
            "La Unidad de Comunicación Social es una instancia de nivel estratégico. Participa en las acciones de promoción de la salud aplicando estrategias comunicacionales que facilitan la movilización y participación comunitaria para modificar estilos y calidad de vida de la población. Es responsable de difundir eficientemente la información relacionada con las políticas, planes, proyectos de la Región Sanitaria a todos los actores clave dentro del ámbito geográfico de su competencia, en coordinación con la Jefatura de la Región Sanitaria, así mismo la divulgación de la normativa sanitaria y de atención a las personas. \n\nApoya a la Jefatura Regional en la generación de consensos, organización de actores clave y en el fortalecimiento de la participación social, promoción de la salud con enfoque de los derechos y deberes de la ciudadanía en materia de salud.",
        subsecciones: [],
    },
    {
